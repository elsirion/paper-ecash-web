...
use crate::designs::{self, DESIGNS};
...
pub fn StepDesign(
    ...
    let select_design = move |id: &str| {
        ...
        if let Some(design) = designs::get_design(id) {
                    ...
                    .map(|d| {
                        ...
                        view! {
                            <div
                                ...
                                on:click=move |_| select_design(id)
                            >
                                <img src=front_url alt=name class="design-thumbnail" />
